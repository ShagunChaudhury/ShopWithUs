...
//set the spinners adapter to the previously created one.
        ...
        AutoCompleteTextView ac=findViewById(R.id.email);
        EditText ed=(EditText) findViewById(R.id.product);
     //   Spinner spinner = (Spinner)findViewById(R.id.spinner1);
        String emailid=ac.getText().toString();
      //  DatabaseHelper mydb;
      //  Cursor result=mydb.searchProducts(emailid);
//        startActivity(new Intent(LoginActivity.this,MainActivity.class) );
